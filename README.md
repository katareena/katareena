...
| ------------- | ------------- | ----- |
| [Photo Inspiration App](https://github.com/katareena/imagehub)<br><br>[Demo](https://imagehub.vercel.app/) | Photo inspiration application with the ability to search and add photos to the favorites list. | TypeScript, React, Context, React Router 6, SCSS, responsive-layout |
