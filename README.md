...
| ------------- | ------------- | ----- |
| [What To Watch (in progress)](https://github.com/katareena/1018255-what-to-watch-10) | Online cinema app with ability to log in, add to favorites list if you login, rate, comment and watch movies. | TypeScript, React, Redux, React Router 6, Jest, Webpack |
